...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.id_lineEdit, 0, 1, 1, 3)

        self.plainTextEdit = QPlainTextEdit(self.groupBox)
        self.plainTextEdit.setObjectName(u"plainTextEdit")

        self.gridLayout_2.addWidget(self.plainTextEdit, 0, 4, 7, 1)
        ...
        self.gridLayout_2.addWidget(self.origin_x_lineEdit, 1, 1, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.origin_y_lineEdit, 2, 1, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.dest_x_lineEdit, 3, 1, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.dest_y_lineEdit, 4, 1, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.velocity_lineEdit, 5, 1, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.red_lineEdit, 7, 1, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.green_lineEdit, 8, 1, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.blue_lineEdit, 9, 1, 1, 3)

        self.add_start_pushButton = QPushButton(self.groupBox)
        self.add_start_pushButton.setObjectName(u"add_start_pushButton")

        self.gridLayout_2.addWidget(self.add_start_pushButton, 10, 0, 1, 2)

        self.sord_id_pushButton = QPushButton(self.groupBox)
        self.sord_id_pushButton.setObjectName(u"sord_id_pushButton")

        self.gridLayout_2.addWidget(self.sord_id_pushButton, 10, 3, 1, 1)

        self.add_end_pushButton = QPushButton(self.groupBox)
        self.add_end_pushButton.setObjectName(u"add_end_pushButton")

        self.gridLayout_2.addWidget(self.add_end_pushButton, 11, 0, 1, 3)

        self.sort_dist_pushButton = QPushButton(self.groupBox)
        self.sort_dist_pushButton.setObjectName(u"sort_dist_pushButton")

        self.gridLayout_2.addWidget(self.sort_dist_pushButton, 11, 3, 1, 1)

        self.print_pushButton = QPushButton(self.groupBox)
        self.print_pushButton.setObjectName(u"print_pushButton")

        self.gridLayout_2.addWidget(self.print_pushButton, 12, 0, 1, 2)

        self.sord_speed_pushButton = QPushButton(self.groupBox)
        self.sord_speed_pushButton.setObjectName(u"sord_speed_pushButton")

        self.gridLayout_2.addWidget(self.sord_speed_pushButton, 12, 2, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sord_id_pushButton.setText(QCoreApplication.translate("MainWindow", u"Ordenar  Id", None))
        self.add_end_pushButton.setText(QCoreApplication.translate("MainWindow", u"Agregar al final", None))
        self.sort_dist_pushButton.setText(QCoreApplication.translate("MainWindow", u"Ordenar distancia", None))
        self.print_pushButton.setText(QCoreApplication.translate("MainWindow", u"Imprimir", None))
        self.sord_speed_pushButton.setText(QCoreApplication.translate("MainWindow", u"Ordenar velocidad", None))
